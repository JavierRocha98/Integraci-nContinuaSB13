 ...
 <head>
 	...
 	<link rel="stylesheet" href="../style/estiloLista.css">
...
while($persona=mysqli_fetch_row($bs->res)){
 ...
 <tr><td><?=$contador?></td><td><?=$persona[1]?></td><td><?=$persona[3]." ".$persona[2]?></td>
 	<td><a href="editarp.php?id=<?=$persona[0]?>" class="btn btn-outline-success btn-sm"><strong>Editar</strong></a><a href="../logica/delete.php?id=<?=$persona[0]?>" class="btn btn-outline-danger btn-sm mx-xl-2 mx-lg-2 mx-md-2 mx-0 mt-xl-0 mt-lg-0 mt-md-0 mt-2"><strong>Eliminar</strong></a></td></tr>
